...
1. Save each correctly solved group to memory (you will re-submit these for free after restart):
   ...
   memory_note(key="solved_2", …) etc.
   Call memory_list first to check if any solved_N entries already exist — don't duplicate.

2. Save strong near-misses and confirmed partial knowledge:
   • If you had a one_away where you know 3 correct words:
     memory_note(key="oneaway_THEME", content="WORD_A,WORD_B,WORD_C confirmed; WORD_X was wrong")
